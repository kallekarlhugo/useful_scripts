...
metadata=/its/home/jp543/lustre/wgs_data/marianne_high
bam_path=$HOME/lustre/wgs_data/marianne_high/raw_bams
...
META="$metadata/sample_metadata_temp.tsv"
while read LINE
do
...
### Run picard tools AddreplaceRGs
    ...
    $HOME/bin/jre1.8.0_161/bin/java -Xmx10g -Djava.io.tmpdir=$HOME/lustre/tmp -jar $HOME/bin/picard.jar AddOrReplaceReadGroups \
      I=$bam_path/${sampleID}_sorted.raw.bam O=$bam_path/${sampleID}.rg.bam RGID=${flow_cell}.${lane} RGLB=${simpleID}.${seqnum} \
